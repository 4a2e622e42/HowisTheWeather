...
public class FourthdayFragment extends Fragment
{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    JSONObject third_object = daily.getJSONObject(3);
                    JSONArray weather = third_object.getJSONArray("weather");
                    ...
                    JSONObject temp = third_object.getJSONObject("temp");
                    String pressure = third_object.getString("pressure");
                    String humidity = third_object.getString("humidity");
                    String wind_speed = third_object.getString("wind_speed");
                    int uvi = third_object.getInt("uvi");
                    int min_temp = temp.getInt("min");
                    int max_temp = temp.getInt("max");
                    String clouds = third_object.getString("clouds");
