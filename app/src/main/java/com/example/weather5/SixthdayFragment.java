...
public class SixthdayFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_sixthday, container, false);
    ...
    protected void  fifth_day_weather()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    JSONObject fifth_object = daily.getJSONObject(5);
                    JSONArray weather = fifth_object.getJSONArray("weather");
                    ...
                    JSONObject temp = fifth_object.getJSONObject("temp");
                    String pressure = fifth_object.getString("pressure");
                    String humidity = fifth_object.getString("humidity");
                    String wind_speed = fifth_object.getString("wind_speed");
                    int uvi = fifth_object.getInt("uvi");
                    int min_temp = temp.getInt("min");
                    int max_temp = temp.getInt("max");
                    String clouds = fifth_object.getString("clouds");
