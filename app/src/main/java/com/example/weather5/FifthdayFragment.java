...
public class FifthdayFragment extends Fragment
{
    ...
    protected void  fourth_day_weather()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    JSONObject fourth_object = daily.getJSONObject(4);
                    JSONArray weather = fourth_object.getJSONArray("weather");
                    ...
                    JSONObject temp = fourth_object.getJSONObject("temp");
                    String pressure = fourth_object.getString("pressure");
                    String humidity = fourth_object.getString("humidity");
                    String wind_speed = fourth_object.getString("wind_speed");
                    int uvi = fourth_object.getInt("uvi");
                    int min_temp = temp.getInt("min");
                    int max_temp = temp.getInt("max");
                    String clouds = fourth_object.getString("clouds");
