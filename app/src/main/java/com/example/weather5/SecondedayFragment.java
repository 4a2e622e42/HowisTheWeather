...
public class SecondedayFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView =  inflater.inflate(R.layout.fragment_secondeday, container, false);
    ...
    protected void toomorrow_weather()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    String pressure = one_object.getString("pressure");
                    String humidity = one_object.getString("humidity");
                    String wind_speed = one_object.getString("wind_speed");
                    int uvi = one_object.getInt("uvi");
