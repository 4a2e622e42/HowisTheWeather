...
public class SeventhdayFragment extends Fragment
{
    ...
    public boolean is_day(long sunset)
    {
        boolean is_day = true;
        Calendar currunt_time = Calendar.getInstance();
        currunt_time.getTimeInMillis();

        Calendar afterSunset = Calendar.getInstance();
        afterSunset.setTimeInMillis(sunset);

        boolean after = currunt_time.after(afterSunset);
    ...
    protected void  sixth_day_weather()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try
                {
                    ...
                    JSONObject seventh_object = daily.getJSONObject(6);
                    JSONArray weather = seventh_object.getJSONArray("weather");
                    ...
                    JSONObject temp = seventh_object.getJSONObject("temp");
                    String pressure = seventh_object.getString("pressure");
                    String humidity = seventh_object.getString("humidity");
                    String wind_speed = seventh_object.getString("wind_speed");
                    int uvi = seventh_object.getInt("uvi");
                    int min_temp = temp.getInt("min");
                    int max_temp = temp.getInt("max");
                    String clouds = seventh_object.getString("clouds");
